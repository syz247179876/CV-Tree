...
if __name__ == '__main__':
    model = get_model('yolov8n-BiFormer-FILR.yaml')
    # model.train(data=DATASET_FLIR_ADAS_V2, epochs=300, batch=16, lr0=0.01, name=f'train-{DATASET_FLIR_ADAS_V2}-BiFormer-16', resume=False)