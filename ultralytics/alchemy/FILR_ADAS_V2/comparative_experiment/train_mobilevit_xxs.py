...
if __name__ == '__main__':
    model = get_model(r'yolov8n-MobileViT-XXS-FILR.yaml')
    model.train(data=DATASET_FLIR_ADAS_V2, epochs=300, batch=8, lr0=0.005, name=f'train-{DATASET_FLIR_ADAS_V2}-MobileViT-XXS-16', resume=False)