...
if __name__ == '__main__':
    model = get_model(r'yolov8n-PoolFormer-S12-FILR.yaml')
    model.train(data=DATASET_FLIR_ADAS_V2, epochs=300, batch=16, lr0=0.01, name=f'train-{DATASET_FLIR_ADAS_V2}-PoolFormer-S12-16', resume=False)