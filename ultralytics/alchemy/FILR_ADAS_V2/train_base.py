...
if __name__ == '__main__':
    model = get_model(r'yolov8s.yaml')
    model.train(data=DATASET_FLIR_ADAS_V2_RGB, epochs=300, batch=16, lr0=0.01, name=f'train-{DATASET_FLIR_ADAS_V2_RGB}-baseline-v8s-16', resume=False)