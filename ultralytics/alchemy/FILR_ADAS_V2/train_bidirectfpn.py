...
if __name__ == '__main__':
    model = get_model(r'yolov8-BiDirectFPN-p2-FILR.yaml')
    model.train(data=DATASET_FLIR_ADAS_V2, epochs=300, batch=32, lr0=0.01, name=f'train-{DATASET_FLIR_ADAS_V2}-BiFPN', resume=False)