...
if __name__ == '__main__':
    model = get_model(r'yolov8-EFPN-GhostConv2-p2-FILR.yaml')
    model.train(data=DATASET_FLIR_ADAS_V2, epochs=300, batch=16, lr0=0.01, name=f'train-{DATASET_FLIR_ADAS_V2}-v8n-EFPN-p2-16', resume=False)