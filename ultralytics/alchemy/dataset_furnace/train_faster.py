...
if __name__ == '__main__':
    model = get_model('yolov8n-Faster-backbone-neck.yaml')
    model.train(data=DATASET_EXDARK, epochs=300, batch=32, lr0=0.01, name=f'train-{DATASET_EXDARK}-Faster-backbone-neck')