...
if __name__ == '__main__':
    model = get_model('yolov8n-PoolFormer-S12.yaml')
    model.train(data=DATASET_VOC, epochs=300, batch=32, lr0=0.01, name=f'train-{DATASET_VOC}-PConv')